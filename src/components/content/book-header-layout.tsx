...
export function BookHeaderLayout() {
  const [open, setOpen] = useState(false);
  const { slug } = useParams() as { slug?: string };

  const category = BOOK_CATEGORIES.find((category) => category.slug === slug);
